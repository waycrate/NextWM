...
static void registry_handle_global(void *, struct wl_registry *, uint32_t,
                                   const char *, uint32_t);
static void next_handle_success(void *, struct next_command_callback_v1 *,
                                const char *);
static void next_handle_failure(void *, struct next_command_callback_v1 *,
                                const char *);
